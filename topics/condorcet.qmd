...
Use sliders to change elector compentence and the number of electors. A new vote take place on any change. 
...
vote = new CondorcetElection(numElectors,indCompetence);
```
